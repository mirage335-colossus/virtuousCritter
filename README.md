...
Development and deployment build framework for both using AI in a 
development context and deploying AI within an application needing internal 
automation.
...
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">Install all of these dependencies if possible. In particular, some 
...
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">Anchor script (eg. &#39;_virtuousCritter.bat&#39;) may call python script 
...
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">Anchor script (eg. &#39;_virtuousCritter.sh&#39;) will call ubiquitous_bash 
function.
...
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">All deployment of virtuousCritter is through performant standalone source 
...
_t '
scriptedIllustrator_markup_uk4uPhB663kVcygT0q --><!-- # --><pre style="margin-top: 0px;margin-bottom: 0px;white-space: pre-wrap;">Obviously AI is powerful. In automation, there is an unavoidable tradeoff 
